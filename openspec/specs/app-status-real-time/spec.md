# App Status Real-Time

## Purpose

ระบบจัดการสถานะ Application แบบ Real-time — Application Hub แสดงสถานะจริงจาก API, Status Indicators (Online/Maintenance/Offline), ซิงค์สถานะทั่วทั้งระบบทันทีโดยไม่ต้องรีสตาร์ท, และบันทึก Audit Log อัตโนมัติทุกครั้งที่มีการเปลี่ยนแปลง
