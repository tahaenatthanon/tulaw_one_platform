...
Specification for the Audit Log Detail View component — structured detail drawer with 6 sections, side-by-side JSON diff with syntax highlighting, copy functionality, and collapse/expand for large JSON.
