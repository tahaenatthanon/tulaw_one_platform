...
*\* System Admin cannot delete Super Admin users or change Super Admin role.*

Permission codes: `USERS_VIEW`, `USERS_CREATE`, `USERS_EDIT`, `USERS_DELETE`, `USERS_MANAGE_ROLES`, `USERS_MANAGE_PERMISSIONS`, `USERS_AD_SYNC`, `USERS_BULK_IMPORT`
...
- **THEN** the system SHALL display all users in read-only mode; Add, Edit, Delete, Import, and AD Sync actions SHALL be hidden
