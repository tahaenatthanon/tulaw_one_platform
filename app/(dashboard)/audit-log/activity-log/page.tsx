...
const EVENT_TYPES = [
  ...
  "DOC_DOWNLOAD", "PERMISSION_CHANGE", "USER_CREATE", "USER_UPDATE",
  "USER_DELETE", "BULK_ASSIGN-ROLE", "BULK_ENABLE", "BULK_DISABLE",
  "USER_LOGOUT", "PROJECT_CREATE", "PROJECT_UPDATE", "PROJECT_DELETE",
  "PROJECT_REJECT", "CSV_IMPORT", "CSV_EXPORT", "AUDIT_EXPORT",
  "ROLE_ASSIGN", "MFA_RESET", "ACCOUNT_UNLOCK", "PASSWORD_RESET",
  "API_KEY_CREATE", "API_KEY_ROTATE", "API_KEY_DISABLE", "API_KEY_DELETE",
  "BULK_UNLOCK", "BULK_RESET_MFA", "DOC_UPDATE",
  "EOFFICE_CREATE", "EOFFICE_APPROVE", "EOFFICE_REJECT",
...
const EVENT_META: Record<string, { label: string; color: string; bg: string }> = {
  ...
  DOC_UPDATE: { label: "DOC_UPDATE", color: "text-tu-info", bg: "bg-tu-info/10" },
