            ...
            >
              ...
              <div className="mb-7">
                ...
                <p className="mt-2 text-sm leading-relaxed text-[#6B7280]">
                  {mfaStep === "password" &&
                    "ลงชื่อเข้าใช้ด้วยบัญชี Active Directory ของคณะ"}
                  {mfaStep === "otp" &&
              ...
              {mfaStep === "password" && (
                <a
                  ...
                  className="group inline-flex h-12 w-full items-center justify-center gap-2.5 rounded-xl border border-[#E5E7EB] bg-white px-4 text-[15px] font-medium text-[#1A1A2E] shadow-sm transition-all duration-200 hover:-translate-y-[1px] hover:border-[#9CA3AF]/40 hover:bg-[#F9FAFB] hover:shadow-md active:translate-y-0"
                >
